from core.library_scope import resolve_book_arg


def test_resolve_book_number_and_all(monkeypatch):
    monkeypatch.setattr(
        "core.library_scope.indexed_books_menu",
...
def test_resolve_invalid_number(monkeypatch):
    monkeypatch.setattr("core.library_scope.indexed_books_menu", lambda: [(1, "a", "A")])
